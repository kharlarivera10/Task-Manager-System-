...
<body class="bg-gradient-to-br from-gray-50 via-white to-blue-50 min-h-screen flex flex-col font-sans text-gray-800">
  ...
  <header class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
      <h1 class="text-2xl font-extrabold tracking-tight drop-shadow-sm">
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-12">
    <div id="app" 
         class="w-full max-w-3xl p-8 bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-gray-200 
                transition transform hover:shadow-2xl hover:scale-[1.01]">
    </div>
  </main>
  ...
  <footer class="bg-gray-100 text-gray-600 text-center py-6 border-t border-gray-200">
    <p class="text-sm">
      ...
      <span class="font-semibold text-gray-800">Task Management System</span>.
      All rights reserved.
    </p>
  </footer>
...
<?php /**PATH C:\Users\ADMIN\TaskManagementSystem\resources\views/app.blade.php ENDPATH**/ ?>